...
df = pd.read_csv('/content/drive/Shared drives/X-DJ/Kuvo-Project/PLAY_TBL+ (nws_2nd_db)_20180501-20190430_edit_tac.csv')

# Init csv
csv_dir = '/content/drive/Shared drives/X-DJ/Kuvo-Project/testdl_opts/record'+ str(datetime.datetime.now().hour) + str(datetime.datetime.now().minute) +'.csv' 
file = open(csv_dir, 'w')
w = csv.writer(file)

dl_dir = '/content/drive/Shared drives/X-DJ/Kuvo-Project/testdl_opts/'
