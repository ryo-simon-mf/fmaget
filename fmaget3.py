...
for page in range(20):
    page += 1
#     base = page + 12
    url = "https://freemusicarchive.org/genre/Country?sort=track_date_published&d=1&page=" + str(page)
    headers = {
    ...
    for onpage in range(elenum):
        ...
        with open('/home/ryo/Documents/fma/song/country/' + filename_image, 'wb') as f:
